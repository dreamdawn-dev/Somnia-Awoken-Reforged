...
fun transformStartSleepInBed(method: MethodNode) {
    ...
    monstersCheck.insert(1) {
        ...
        getstatic("com/github/dreamdawn_dev/somnia/SomniaConfig", "COMMON", "com/github/dreamdawn_dev/somnia/SomniaConfig\$CommonConfig")
        getfield("com/github/dreamdawn_dev/somnia/SomniaConfig\$CommonConfig", "ignoreMonsters", "net/minecraftforge/common/ForgeConfigSpec\$BooleanValue")
