...
public class FatigueStore implements Fatigue {
    ...
    public boolean updateFatigueCounter() {
        return System.currentTimeMillis() - this.lastFatigueSync >= 5000;
    }

    @Override
    public void maxFatigueCounter() {
        this.lastFatigueSync = 0;
    }
    ...
    @Override
    public boolean isAcceleratedSleep() {
        return this.acceleratedSleep;
    }

    @Override
    public void setAcceleratedSleep(boolean acceleratedSleep) {
        this.acceleratedSleep = acceleratedSleep;
    }
